...
namespace DataBase
{
    public class SqlDbHelper
    {
        ...
        /// 连接字符串  
        /// </summary>  
        public static readonly string connectionString = "server =.; database=Base;User ID = sa; Pwd=123.com";
        ...
        /// <param name="values">参数数组</param>  
        /// <returns>第一行第一列的值</returns>  
        public static string ExecuteScalar(string sql, SqlParameter[] values)
        {
            using (SqlConnection Connection = new SqlConnection(connectionString))
            {
                if (Connection.State != ConnectionState.Open)
        ...
        ///  <param name="outstring">输出参数名字</param>     
        ///  /// <returns>输出集合</returns>  
        public static List<String> ExceProc(string ProcName, SqlParameter[] sp, string[] outstring)
        {
            ...
            try
            {
                ...
                using (SqlConnection Connection = new SqlConnection(connectionString))
                {
                    ...
                    myCommand.Parameters.AddRange(sp);
                    var i = myCommand.ExecuteNonQuery().ToString();
                    ...
                    if (outstring != null)
                    {
                        ...
                        {
                            string value = myCommand.Parameters[item].Value.ToString(); //@Output_Value和具体的存储过程参数对应
                            outlist.Add(value);
                            //  string p_id = myCommand.Parameters["@P_ID"].Value.ToString(); ;
                    ...
                    outlist.Add(i);
                    return outlist;
                    //string[] outstr = new string[] {code,p_id };
